...
new Vue({
  ...
  data: {
    ...
    toUpdateTime: '',
    isEdit: false,
    menuList: [{ title: 'My Tasks', type: 'all' }, { title: 'In Progress', type: 'progress' }, { title: 'Completed', type: 'completed' }],
    list: [{ name: '煮泡麵', time: '05/17', comment: '45465464654', file: '', Sticky: false, complete: false }, { name: '煎蛋', time: '06/21', comment: '00000000000', file: '', Sticky: false, complete: false }, { name: '炒高麗', time: '10/14', comment: '00000000000', file: '', Sticky: false, complete: false }],
    finishList: []
  },
  computed: {
    listItemRow: function listItemRow() {
      var self = this;
      var arr = [];
      if (this.nowType == 'all') {
  ...
  methods: {
    sortData: function sortData(data) {
      return data.sort(function (a, b) {
        var scoreA = (a.Sticky ? -10000 : 0) + (a.complete ? 20000 : 0);
        var scoreB = (b.Sticky ? -10000 : 0) + (b.complete ? 20000 : 0);
    ...
    changeType: function changeType(param) {
      this.nowType = param;
    },
    ...
    finishItem: function finishItem(index) {
